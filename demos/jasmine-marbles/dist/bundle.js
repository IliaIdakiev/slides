...
Object.defineProperty(exports, "__esModule", { value: true });
var fetch_1 = __webpack_require__(/*! ../internal/observable/dom/fetch */ "./node_modules/rxjs/internal/observable/dom/fetch.js");
...
/*!********************!*\
  !*** ./src/app.ts ***!
  \********************/
/*! exports provided: MessageBus, AppEffects, App */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var rxjs_fetch__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/fetch */ "./node_modules/rxjs/fetch/index.js");
/* harmony import */ var rxjs_fetch__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(rxjs_fetch__WEBPACK_IMPORTED_MODULE_3__);
...
var UserService = {
    login: function (data) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])({ firstName: 'Ivan', lastName: 'Ivanov' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["delay"])(2000)); },
    loadUsers: function () { return Object(rxjs_fetch__WEBPACK_IMPORTED_MODULE_3__["fromFetch"])('https://jsonplaceholder.typicode.com/users').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (data) {
        if (data.ok) {
            return data.json();
        }
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])('Could not fetch!');
    })); }
};
var MessageBus = /** @class */ (function () {
    function MessageBus() {
        this._mbus = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        this._mbus.subscribe(console.log);
    }
    MessageBus.prototype.listen = function (type) {
        return this._mbus.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function (m) { return m.type === type; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (m) { return m.data; }));
    };
...
var AppEffects = /** @class */ (function () {
    function AppEffects(messageBus) {
        ...
        this.login$ = this.messageBus.listen('[AUTH] Login').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (data) { return UserService.login(data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (user) { return [
            { type: '[AUTH] Login Success', data: user },
            { type: '[USERS] Load Users', data: null }
        ]; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])({ type: '[GLOBAL] Set Loader', data: true }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) { return [{ type: '[USERS] Load Users Failed', data: error }]; })); }));
        this.loadUsers$ = this.messageBus.listen('[USERS] Load Users').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function () { return UserService.loadUsers().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (users) { return [
            { type: '[USERS] Load Users Success', data: users },
            { type: '[GLOBAL] Set Loader', data: false }
        ]; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) { return [{ type: '[USERS] Load Users Failed', data: error }]; })); }));
        this.connect = function () {
            rxjs__WEBPACK_IMPORTED_MODULE_2__["merge"].apply(void 0, Object.values(_this).filter(function (val) { return val instanceof rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"]; })).subscribe(_this.messageBus._mbus);
        };
    }
    return AppEffects;
}());

var appLogin = function (context) { return Object(lit_html__WEBPACK_IMPORTED_MODULE_1__["html"])(templateObject_1 || (templateObject_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"](["\n<div>Login</div>\n<form>\n  <div class=\"form-group\">\n    <label for=\"email\">Email</label>\n    <input type=\"email\" id=\"email\" @keyup=", "/>\n  </div>\n  <div class=\"form-group\">\n    <label for=\"password\">Password</label>\n    <input type=\"password\" id=\"password\" @keyup=", "/>\n  </div>\n  <button type=\"button\" @click=", ">Login</button>\n</form>\n"], ["\n<div>Login</div>\n<form>\n  <div class=\"form-group\">\n    <label for=\"email\">Email</label>\n    <input type=\"email\" id=\"email\" @keyup=", "/>\n  </div>\n  <div class=\"form-group\">\n    <label for=\"password\">Password</label>\n    <input type=\"password\" id=\"password\" @keyup=", "/>\n  </div>\n  <button type=\"button\" @click=", ">Login</button>\n</form>\n"])), function (e) { return context.formData.email = e.target.value; }, function (e) { return context.formData.password = e.target.value; }, function () { return context.loginHandler(context.formData); }); };
var appLoading = function (context) { return Object(lit_html__WEBPACK_IMPORTED_MODULE_1__["html"])(templateObject_2 || (templateObject_2 = tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"](["<div>Loading...</div>"], ["<div>Loading...</div>"]))); };
var appLoggedIn = function (context) { return Object(lit_html__WEBPACK_IMPORTED_MODULE_1__["html"])(templateObject_4 || (templateObject_4 = tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"](["<div>\n  <div>Hello ", "!</div>\n  <div>", "</div>\n</div>"], ["<div>\n  <div>Hello ", "!</div>\n  <div>", "</div>\n</div>"])), context.loggedUser.firstName, context.userList.map(function (user) { return Object(lit_html__WEBPACK_IMPORTED_MODULE_1__["html"])(templateObject_3 || (templateObject_3 = tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"](["<li>", "</li>"], ["<li>", "</li>"])), user.username); })); };
var App = /** @class */ (function (_super) {
    ...
    function App(messageBus) {
        ...
        _this.render = function () {
            ...
            Object(lit_html__WEBPACK_IMPORTED_MODULE_1__["render"])(template(_this), root);
        };
        _this.render();
...
(function init() {
    var messageBus = new _app__WEBPACK_IMPORTED_MODULE_0__["MessageBus"]();
    var appEffects = new _app__WEBPACK_IMPORTED_MODULE_0__["AppEffects"](messageBus);
    appEffects.connect();
    var app = new _app__WEBPACK_IMPORTED_MODULE_0__["App"](messageBus);
